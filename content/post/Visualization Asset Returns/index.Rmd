...
highchart(type = "stock") %>%
  ...
  # Wrap the high charter object in an iframe
  # We only do so to properly display this plot object properly in blogdown
  frameWidget(height = "625%")
```
...
```{r, echo=FALSE}
list_of_histogram[[1]] %>% frameWidget(height = "625%")
```

```{r, echo=FALSE}
list_of_histogram[[2]] %>% frameWidget(height = "625%")
```

```{r, echo=FALSE}
list_of_histogram[[3]] %>% frameWidget(height = "625%")
```

```{r, echo=FALSE}
list_of_histogram[[4]] %>% frameWidget(height = "625%")
```

```{r, echo=FALSE}
list_of_histogram[[5]] %>% frameWidget(height = "625%")
```
