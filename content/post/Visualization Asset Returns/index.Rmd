...
highchart(type = "stock") %>%
  ...
  htmlwidgets::saveWidget(file = "figure.html", selfcontained = TRUE)
```

<iframe height = 550 width = 100% src = "figure.html"></iframe>
...
Hover over the line chart to see how you can interact with it.
...
Now, we utilize the functional programming tool from `purrr` to apply the function above to each of the five univariate returns series.  
...
```{r, include=FALSE}
# Save the html widgets
list_of_histogram[[1]] %>% htmlwidgets::saveWidget(file = "histogram1.html", selfcontained = TRUE)
list_of_histogram[[2]] %>% htmlwidgets::saveWidget(file = "histogram2.html", selfcontained = TRUE)
list_of_histogram[[3]] %>% htmlwidgets::saveWidget(file = "histogram3.html", selfcontained = TRUE)
list_of_histogram[[4]] %>% htmlwidgets::saveWidget(file = "histogram4.html", selfcontained = TRUE)
list_of_histogram[[5]] %>% htmlwidgets::saveWidget(file = "histogram5.html", selfcontained = TRUE)
```

<iframe height = 550 width = 100% src = "histogram1.html"></iframe>
<iframe height = 550 width = 100% src = "histogram2.html"></iframe>
<iframe height = 550 width = 100% src = "histogram3.html"></iframe>
<iframe height = 550 width = 100% src = "histogram4.html"></iframe>
<iframe height = 550 width = 100% src = "histogram5.html"></iframe>
